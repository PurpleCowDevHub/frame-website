...
class GlassElement extends HTMLElement {
    ...
    // Profundidad fija (sin cambio al hacer clic)
    get depth() {
        return this.baseDepth;
    }

    setupEventListeners() {
        // Interacciones de click deshabilitadas para evitar distorsión elástica
    }
    ...
    applyDynamicStyles(element) {
        ...
        if (this.autoSize) {
            ...
            if (this.debug) {
                ...
                element.style.boxShadow = 'inset 1px 1px 1px rgba(255,255,255,0.35), inset -1px -1px 1px rgba(255,255,255,0.18), inset 0 -8px 18px rgba(0,0,0,0.035), 0 10px 28px rgba(0,0,0,0.035)';
        ...
        this.shadowRoot.innerHTML = `
            <style>
                ...
                .glass-box {
                    ...
                    box-shadow: inset 1px 1px 1px rgba(255,255,255,0.35), inset -1px -1px 1px rgba(255,255,255,0.18), inset 0 -8px 18px rgba(0,0,0,0.035), 0 10px 28px rgba(0,0,0,0.035);
                    cursor: pointer;
